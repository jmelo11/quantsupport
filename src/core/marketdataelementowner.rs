...
//         volatilityelements::{VolatilityCubeElement, VolatilitySurfaceElement},
//     },
...
//     /// Creates a new [`MarketDataElementOwner`] with the specified evaluation date.
//     #[must_use]
...
//     /// Creates a new [`MarketDataElementOwner`] with the specified evaluation date and pre-loaded market data elements.
//     #[must_use]
...
//             .nodes_mut()
//             .insert(
//                 VolatilityNodeKey::new(market_index.clone(), date, axis),
//                 value,
//             );
//         self
//     }
...
//                             ))
//                         })?;
//                     response.volatility_nodes_mut().insert(
//                         VolatilityNodeKey::new(market_index.clone(), *date, *axis),
//                         node,
//                     );
//                 }
